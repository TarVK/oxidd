...
```txt
OXIDD_PYFFI_LINK_MODE=static python -m pip install "oxidd @ git+https://git@github.com/TarVK/oxidd.git/feature/visualize"
```
...
After successful installation, Python bindings should be available. With [OxiDD-Viz](https://oxidd.net/viz/) opened, you should now be able to execute scripts with visualization calls:
...
mgr.dump_dddmp_file("test.dddmmp", [(x, "x"), (y, "y"), (z, "z"), (w, "w")])
```
...
```toml
[dependencies]
oxidd = { git = "https://github.com/TarVK/oxidd", branch = "feature/visualize" }
```

Now with [OxiDD-Viz](https://oxidd.net/viz/) opened, your Rust code should be able make visualization calls:
